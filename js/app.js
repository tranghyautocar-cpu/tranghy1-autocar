...
const pdf = new jsPDF('p', 'mm', 'a4');
 ...
 getFallbackDrivers: () => {
   ...
   getFallbackCars: () => [    
    ...
    { id: 13, name: "Toyota Fortuner", category: "7", price: 1700000, status: "Sẵn sàng", image_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/29/2016_Toyota_Fortuner_%28GUN156R%29_Crusade_wagon_%282016-01-28%29_01.jpg/800px-2016_Toyota_Fortuner_%28GUN156R%29_Crusade_wagon_%282016-01-28%29_01.jpg", desc: "SUV đa dụng." },
    ...
    { id: 25, name: "Ford Ranger", category: "5", price: 1400000, status: "Sẵn sàng", image_url: "https://images.unsplash.com/photo-1605893466208-f9d129a36746?q=80&w=800", desc: "Bán tải đa dụng." }
    ]
};
